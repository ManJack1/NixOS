# Generated by Powerlevel10k configuration wizard on 2023-07-06 at 20:25 CST.
...
# 12h time, 2 lines, disconnected, left frame, blue-ornaments, sparse, many icons,
...
() {
  ...
  #################################[ os_icon: os identifier ]##################################
  # OS identifier color.
  typeset -g POWERLEVEL9K_OS_ICON_FOREGROUND="#6699cc" 
  # Custom icon.
